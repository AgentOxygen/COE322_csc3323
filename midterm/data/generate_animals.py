#!/usr/bin/env python3
"""
COE 322 Homework 01 Updated for Midterm Project

@author: Cameron Cummins
"""

import json, sys, uuid, time, datetime
...
def genAnimal() -> dict:
    ...
    dict
        A complete description of a generated animal according to Dr. Moreau's specifications:
            - Timestamp when this animal was created on
            - A UID for this specific animal
    ...
    animal["created_on"] = datetime.datetime.fromtimestamp(time.time()).strftime('%Y-%m-%d %H:%M:%S')
...
if __name__ == "__main__":
    genAnimalsJSON(20, sys.argv[1]) #sys.argv[1]
